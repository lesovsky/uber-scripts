...
from pg_stat_user_tables
where
  pg_relation_size(relname::regclass) < 1000000000
  and pg_relation_size(relname::regclass) >= 300000000 -- more or equal than 300MB
...
from pg_stat_user_tables
where
  pg_relation_size(relname::regclass) < 300000000 -- less than 300MB
